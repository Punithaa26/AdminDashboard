          ...
          <div className="relative z-50">
            ...
            <div className="relative w-full rounded-md p-[2px] bg-gray-500">
              <button
                ...
                className="bg-[#121212] text-sm text-white px-4 py-2 rounded-md w-full flex items-center justify-between gap-2 hover:bg-[#1a1a1a] transition-colors min-w-[140px]"
              >
                <span>{timeRange}</span>
                <ChevronDown
                ...
                <div className="absolute top-full left-0 right-0 mt-1 bg-[#1a1a1a] border border-white/10 rounded-md shadow-lg z-[60] max-h-48 overflow-y-auto">
                  {filterOptions.timeRanges?.map((range) => (
                    <button
                      ...
                      className={`w-full text-left text-small px-4 py-2 hover:bg-white/5 text-white text-sm first:rounded-t-md last:rounded-b-md transition-colors ${
